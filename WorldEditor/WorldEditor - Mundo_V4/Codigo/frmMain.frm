...
Begin VB.Form frmMain 
   ...
   Caption         =   "WorldEditor DesteriumAO Exodo II"
   ClientHeight    =   10740
   ClientLeft      =   390
   ClientTop       =   840
   ClientWidth     =   18315
   ...
   Begin VB.PictureBox pPaneles 
      ...
      Begin VB.ComboBox cCapas 
         ...
         ForeColor       =   &H80000014&
         Height          =   330
         ItemData        =   "frmMain.frx":1BA18
         Left            =   1080
         List            =   "frmMain.frx":1BA28
         TabIndex        =   1
         TabStop         =   0   'False
         Text            =   "1"
         Top             =   3120
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   2
         ItemData        =   "frmMain.frx":1BA38
         Left            =   3360
         List            =   "frmMain.frx":1BA3A
         TabIndex        =   67
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   2
         ItemData        =   "frmMain.frx":1BA3C
         Left            =   840
         List            =   "frmMain.frx":1BA3E
         TabIndex        =   0
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   0
         ItemData        =   "frmMain.frx":1BA40
         Left            =   840
         List            =   "frmMain.frx":1BA42
         TabIndex        =   58
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   0
         ItemData        =   "frmMain.frx":1BA44
         Left            =   3360
         List            =   "frmMain.frx":1BA46
         TabIndex        =   57
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   1
         ItemData        =   "frmMain.frx":1BA48
         Left            =   840
         List            =   "frmMain.frx":1BA4A
         TabIndex        =   77
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   1
         ItemData        =   "frmMain.frx":1BA4C
         Left            =   3360
         List            =   "frmMain.frx":1BA4E
         TabIndex        =   80
         Text            =   "500"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   3210
         Index           =   4
         ItemData        =   "frmMain.frx":1BA50
         Left            =   120
         List            =   "frmMain.frx":1BA52
         TabIndex        =   54
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   1
         ItemData        =   "frmMain.frx":1BA54
         Left            =   120
         List            =   "frmMain.frx":1BA56
         TabIndex        =   55
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   2
         ItemData        =   "frmMain.frx":1BA58
         Left            =   120
         List            =   "frmMain.frx":1BA5A
         TabIndex        =   79
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.Frame cLuces 
         ...
         Begin VB.ComboBox Combo1 
            Height          =   315
            ItemData        =   "frmMain.frx":1BA5C
            Left            =   2400
            List            =   "frmMain.frx":1BA6C
            TabIndex        =   119
            Text            =   "Mañana"
            Top             =   600
            Width           =   1335
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   0
         ItemData        =   "frmMain.frx":1BA8B
         Left            =   120
         List            =   "frmMain.frx":1BA8D
         Sorted          =   -1  'True
         TabIndex        =   71
         Tag             =   "-1"
         Top             =   120
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   3
         ItemData        =   "frmMain.frx":1BA8F
         Left            =   120
         List            =   "frmMain.frx":1BA91
         TabIndex        =   66
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
...
Dim MapaArriba As Integer
Dim MapaAbajo As Integer
Dim MapaIzquierda As Integer
Dim MapaDerecha As Integer


' Traslados De Izquierda
For X = 1 To 11
    For Y = 1 To 100
        If MapData(X, Y).TileExit.Map > 0 Then
            If MapaIzquierda = 0 Then
                MapaIzquierda = MapData(X, Y).TileExit.Map
            End If
...
For X = 1 To 100
    For Y = 90 To 100
        If MapData(X, Y).TileExit.Map > 0 Then
            If MapaAbajo = 0 Then
                MapaAbajo = MapData(X, Y).TileExit.Map
            End If
            MapData(X, Y).TileExit.Map = 0
            MapData(X, Y).TileExit.X = 0
            MapData(X, Y).TileExit.Y = 0
...
For X = 1 To 100
    For Y = 1 To 12
        If MapData(X, Y).TileExit.Map > 0 Then
            If MapaArriba = 0 Then
                MapaArriba = MapData(X, Y).TileExit.Map
            End If
            MapData(X, Y).TileExit.Map = 0
            MapData(X, Y).TileExit.X = 0
            MapData(X, Y).TileExit.Y = 0
...
For X = 88 To 100
    For Y = 1 To 100
        If MapData(X, Y).TileExit.Map > 0 Then
            If MapaDerecha = 0 Then
                MapaDerecha = MapData(X, Y).TileExit.Map
            End If
            MapData(X, Y).TileExit.Map = 0
            MapData(X, Y).TileExit.X = 0
            MapData(X, Y).TileExit.Y = 0
...
'MsgBox MapaDerecha
TrasladosAutomaticos MapaArriba, MapaAbajo, MapaIzquierda, MapaDerecha
Call Bloquear_Bordes
'Set changed flag
MapInfo.Changed = 1
End Sub
...
Public Sub TrasladosAutomaticos(ByVal MapaArriba As Integer, ByVal MapaAbajo As Integer, ByVal MapaIzquierda As Integer, ByVal MapaDerecha As Integer)
On Error Resume Next
Dim Y As Integer
Dim X As Integer
...
' ARRIBA
    ...
    For X = 13 To 88
        If MapData(X, Y).Blocked = 0 Then
            MapData(X, Y).TileExit.Map = MapaArriba
            MapData(X, Y).TileExit.X = X
            MapData(X, Y).TileExit.Y = 91
        End If
    Next X
End If
...
' DERECHA
    ...
    For Y = 10 To 91
        If MapData(X, Y).Blocked = 0 Then
            MapData(X, Y).TileExit.Map = MapaDerecha
            MapData(X, Y).TileExit.X = 13
...
' ABAJO
    ...
    For X = 13 To 88
        If MapData(X, Y).Blocked = 0 Then
            MapData(X, Y).TileExit.Map = MapaAbajo
            MapData(X, Y).TileExit.X = X
            MapData(X, Y).TileExit.Y = 10
        End If
    Next X
End If
...
' IZQUIERDA
    ...
    For Y = 10 To 91
        If MapData(X, Y).Blocked = 0 Then
            MapData(X, Y).TileExit.Map = MapaIzquierda
            MapData(X, Y).TileExit.X = 88
            MapData(X, Y).TileExit.Y = Y
        End If
    Next Y
End If
