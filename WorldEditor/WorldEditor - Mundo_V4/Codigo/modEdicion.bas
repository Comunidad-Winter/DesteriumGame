...
For Y = YMinMapSize To YMaxMapSize
    For X = XMinMapSize To XMaxMapSize
        If X < MinXBorder + 3 Or X > MaxXBorder - 3 Or Y < MinYBorder + 2 Or Y > MaxYBorder - 2 Then
...
'//bloqueamos los cuatro lugares pedorros
MapData(89, 92).Blocked = 1
MapData(89, 9).Blocked = 1
MapData(12, 9).Blocked = 1
MapData(12, 92).Blocked = 1
