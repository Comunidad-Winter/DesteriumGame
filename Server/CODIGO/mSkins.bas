...
Public Function Skins_SearchBuyed(ByVal UserIndex As Integer, _
...
Private Function Skins_SearchSlot(ByVal UserIndex As Integer, _
    ...
    With UserList(UserIndex)
        ...
        For A = 1 To MAX_INVENTORY_SKINS
...
Skins_SearchSlot_Err:
    LogError Err.description & vbCrLf & "in ServidorArgentum.mSkins.Skins_SearchSlot " & "at line " & Erl
...
Skins_AddNew_Err:
    LogError Err.description & vbCrLf & "in ServidorArgentum.mSkins.Skins_Desequipar " & "at line " & Erl
        
    '</EhFooter>
End Sub

Public Sub Skins_AddNew(ByVal UserIndex As Integer, ByVal ObjIndex As Integer)
    ...
    With UserList(UserIndex)
        ...
        If .Skins.Last = MAX_INVENTORY_SKINS Then
            Call WriteConsoleMsg(UserIndex, "Tu personaje no permite equipar más skins.", FontTypeNames.FONTTYPE_INFORED)
            Exit Sub
...
Skins_AddNew_Err:
    LogError Err.description & vbCrLf & "in ServidorArgentum.mSkins.Skins_AddNew " & "at line " & Erl
        
    '</EhFooter>
End Sub

' # Chequea si puede comprar la skin
Public Function Skins_CheckBuy_Guild(ByVal UserIndex As Integer, _
                                     ByVal ObjIndex As Integer) As Boolean
...
Public Function Skins_CheckGuild(ByVal UserIndex As Integer, _
                                 ByVal Killed As Boolean) As Boolean
...
Skins_SettingData_Err:
    LogError Err.description & vbCrLf & "in ServidorArgentum.mSkins.Skins_SettingData " & "at line " & Erl
