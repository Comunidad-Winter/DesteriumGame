...
Public Function Porcentaje_Per_Value(ByVal Value As Long, _
                                     ByVal ValueMax As Long) As Single
...
Public Function Porcentaje_Per_Frags(ByVal Frags As Long, _
                                     ByVal FragsMax As Long) As Single
...
Public Function Porcentaje_Per_Level(ByVal Level As Long, _
                                     ByVal LevelMax As Long) As Single
...
Public Function MaxKills(ByVal TeamCant As Integer, _
                         ByVal CuposMax As Integer, _
                         ByVal Rounds As Integer, _
                         ByVal RoundsFinal As Integer) As Integer
