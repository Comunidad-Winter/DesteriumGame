...
Begin VB.Form frmMain 
   ...
   Caption         =   "Desterium ModTDS - Reparado por Lorwik"
   ClientHeight    =   7110
   ClientLeft      =   1950
   ClientTop       =   1515
   ClientWidth     =   13110
...
setNOTIFYICONDATA_Err:
    LogError Err.description & vbCrLf & "in ServidorArgentum.frmMain.setNOTIFYICONDATA " & "at line " & Erl
...
Sub CheckIdleUser()
    ...
    For iUserIndex = 1 To LastUser
        ...
        If iUserIndex <> SLOT_TERMINAL_ARCHIVE Then
            ...
            With UserList(iUserIndex)
                ...
                If .flags.UserLogged Then
                    ...
                    If .Counters.IdleCount >= IdleLimit Then
                        ...
                        Call WriteDisconnect(iUserIndex)
...
CheckIdleUser_Err:
    LogError Err.description & vbCrLf & "in ServidorArgentum.frmMain.CheckIdleUser " & "at line " & Erl
...
cmbShop_Click_Err:
    LogError Err.description & vbCrLf & "in ServidorArgentum.frmMain.cmbShop_Click " & "at line " & Erl
...
cmdCerrarServer_Click_Err:
    LogError Err.description & vbCrLf & "in cmdCerrarServer_Click " & "at line " & Erl
...
Command1_Click_Err:
    LogError Err.description & vbCrLf & "in ServidorArgentum.frmMain.Command1_Click " & "at line " & Erl
...
Form_MouseMove_Err:
    LogError Err.description & vbCrLf & "in ServidorArgentum.frmMain.Form_MouseMove " & "at line " & Erl
...
QuitarIconoSystray_Err:
    LogError Err.description & vbCrLf & "in ServidorArgentum.frmMain.QuitarIconoSystray " & "at line " & Erl
...
Form_Unload_Err:
    LogError Err.description & vbCrLf & "in ServidorArgentum.frmMain.Form_Unload " & "at line " & Erl
...
KillLog_Timer_Err:
    LogError Err.description & vbCrLf & "in ServidorArgentum.frmMain.KillLog_Timer " & "at line " & Erl
