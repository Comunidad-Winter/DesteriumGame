...
Public Function CalculatePorc(ByVal PorcInitial As Byte, _
                              ByVal AddStep As Byte, _
                              ByVal MaxStep As Byte) As Byte
...
Public Function CalculateDuration(ByVal Porc As Byte, _
                                  ByVal Level As Byte, _
                                  ByVal AddStep As Byte, _
                                  ByVal MaxStep As Byte) As Long
