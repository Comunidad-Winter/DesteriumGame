...
LoadRecords_Err:
    LogError Err.description & vbCrLf & "in ServidorArgentum.modUserRecords.LoadRecords " & "at line " & Erl
...
SaveRecords_Err:
    LogError Err.description & vbCrLf & "in ServidorArgentum.modUserRecords.SaveRecords " & "at line " & Erl
...
AddRecord_Err:
    LogError Err.description & vbCrLf & "in ServidorArgentum.modUserRecords.AddRecord " & "at line " & Erl
...
AddObs_Err:
    LogError Err.description & vbCrLf & "in ServidorArgentum.modUserRecords.AddObs " & "at line " & Erl
...
RemoveRecord_Err:
    LogError Err.description & vbCrLf & "in ServidorArgentum.modUserRecords.RemoveRecord " & "at line " & Erl
...
CreateRecordsFile_Err:
    LogError Err.description & vbCrLf & "in ServidorArgentum.modUserRecords.CreateRecordsFile " & "at line " & Erl
