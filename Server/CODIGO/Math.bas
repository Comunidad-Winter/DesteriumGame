...
Public Function Angulo(ByVal X1 As Integer, _
                       ByVal Y1 As Integer, _
                       ByVal X2 As Integer, _
                       ByVal Y2 As Integer) As Single
...
Public Sub RestToVar(ByRef Var As Integer, _
...
Public Function RandomNumberPower(ByVal LowerBound As Long, _
                                  ByVal UpperBound As Long) As Long
