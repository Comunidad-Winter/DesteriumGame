...
Public Sub Prepare_And_Connect(ByVal Mode As E_MODO, _
                               Optional ByRef Parent As Form = Nothing, _
                               Optional ByRef sIPAddress As String = vbNullString, _
                               Optional ByVal nPort As Integer = 0)
