...
Public Sub SelectedPanelAccount(ByVal Panel As eAccount_PanelSelected)
    ...
    Account_PanelSelected = Panel
    
    ' False All
    For A = lblPJ.LBound To lblPJ.UBound
        lblPJ(A).visible = False
    Next A
    
    For A = imgGenero.LBound To imgGenero.UBound
        imgGenero(A).visible = False
    Next A
    
    For A = imgClass.LBound To imgClass.UBound
        imgClass(A).visible = False
    Next A
    
    For A = imgRaza.LBound To imgRaza.UBound
        imgRaza(A).visible = False
    Next A
    ...
    For A = imgHead.LBound To imgHead.UBound
        imgHead(A).visible = False
    Next A
    
    For A = imgHeading.LBound To imgHeading.UBound
        imgHeading(A).visible = False
    Next A
    
    txtName.visible = False
    txtName.Text = vbNullString
    imgLogin.visible = False
    imgNewChar.visible = False
    imgNewChar.visible = False
    TimeButton = 0
    ...
    Select Case Account_PanelSelected
        ...
        Case eAccount_PanelSelected.ePanelAccountCharNew
            ...
            UserRaza = 1
            UserSexo = 1
            Account.RenderHeading = E_Heading.SOUTH
            ...
            For A = imgRaza.LBound To imgRaza.UBound
                imgRaza(A).visible = True
            Next A

            For A = imgClass.LBound To imgClass.UBound
                imgClass(A).visible = True
            Next A

            For A = imgHead.LBound To imgHead.UBound
                imgHead(A).visible = True
            Next A

            For A = imgHeading.LBound To imgHeading.UBound
                imgHeading(A).visible = True
            Next A

            For A = imgGenero.LBound To imgGenero.UBound
                imgGenero(A).visible = True
            Next A
            
            txtName.visible = True
            imgNewChar.visible = True
