...
Public Function System_GetData() As String
    ...
    For Each Info In Results 'Info.Version can be used to calculate Windows version. E.G. If Val(Left$(Info.Version,3)>=6.1 then it is at least Windows 7.
        ...
        PCInfo = Info.Caption & " - " & Info.version & "  SP " & Info.ServicePackMajorVersion & "." & Info.ServicePackMinorVersion & "  " & Info.OSArchitecture & "  " & vbNewLine
    ...
    For Each Info In Results
        ...
        PCInfo = PCInfo & Info.Name & "  " & Info.AddressWidth & "-bit." & vbNewLine & Info.NumberOfLogicalProcessors & " Cores " & Info.CurrentClockSpeed & "MHz.  " & Ram
    Next Info
