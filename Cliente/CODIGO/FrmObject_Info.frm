...
Private Sub Prepare_Object()
    ...
    If Obj.LvlMin > 0 Then
        Call Add_Line("Nivel Mínimo: " & Obj.LvlMin, ARGB(255, 255, 255, 255), eFonts.f_Verdana, 14)

    End If
    
    If Obj.LvlMax > 0 Then
        Call Add_Line("Nivel Máximo: " & Obj.LvlMax, ARGB(255, 255, 255, 255), eFonts.f_Verdana, 14)
